...
$getToken = HttpsPost($loginUrl, NULL, $loginCookie, NULL);
// 正则匹配token
...
HttpsPost($submitUrl, $postData, $submitCookie, $loginCookie);

//登录个人中心页面获取用户名称
$infoUrl = "https://github.com/settings/profile";
$getName = HttpsPost($infoUrl, NULL, $submitCookie, $submitCookie);
//正则匹配用户名
 ...
 * @return mixed  $data        响应体
 */
function HttpsPost($url, $postData, $saveCookie, $useCookie){
    $ch=curl_init();
